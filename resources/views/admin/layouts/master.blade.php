...
<head>
    ...
    <style>
        *{
        ...
        .c-dashboard-content{
            margin-left: 200px; /* Adjusted width to include space for the sidebar */
            padding-top: 50px; /* Added to prevent content from being hidden behind header */
...
<main>
    <div class="c-left-sidebar">
        ...
        <h3 class="c-logo-text">Rehab Care</h3>
        </div>
        <ul>

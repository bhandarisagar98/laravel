...
<main>
    <div class="c-left-sidebar">
        ...
        <ul>
            <li><a href="/staff/entry-form">View Admission Forms</a></li>
            <li><a href="/staff/patient-activity">Patient Activity</a></li>
            <li><a href="/staff/video-meet">Send Video Meet Link</a></li>
        </ul>
    </div>
